            ...
            <form action="{{ route('admin.login.authenticate') }}" method="post" class="login-form" data-bb-toggle="login-form-toggle">
                ...
                <div class="form-header mb-4">
                    ...
                    <div class="login-logo">
                        ...
                        <a href="{{ route('admin.dashboard') }}"><img src="{{ asset('vendor/fog-admin/assets/images/logo.png') }}" alt="logo"></a>
                ...
                <div class="login-other-link mb-4">
                    ...
                    <div class="login-methods">
                        <button type="reset" class="google-login">
                            <img src="{{asset('vendor/fog-admin/assets/images/icon-images/google-icon.png')}}" alt="google-icon">
                        </button>
                        <button type="reset" class="facebook-login">
                            <img src="{{asset('vendor/fog-admin/assets/images/icon-images/github-icon.png')}}"
                                 alt="facebook-icon">
                        </button>
                    </div>
                </div>
